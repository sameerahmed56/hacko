var aap = angular
    ...
    aap.controller("myCtrl",function($scope, $http){
        $http.get('https://3815e3a0f72a.ngrok.io/receptionpending/')
    ...
    aap.controller("newsController", function ($scope, $http) {
        ...
        $http.get('https://3815e3a0f72a.ngrok.io/news/show/')
            .then(function (response) {
                $scope.employees = response.data;
                console.log($scope.employees)
            })
    ...
    aap.controller("askController", function ($scope, $http) {
        ...
        if( a == true){
                ...
                $http.post("https://3815e3a0f72a.ngrok.io/stranger/ask_query/", JSON.stringify(data))
                    .then(function (response) {
                        console.log(response);
                        console.log(response.data);
                        alert('successfully Send')
                        // window.location.href = "/landing-page.html/patient/ask_query.html";
